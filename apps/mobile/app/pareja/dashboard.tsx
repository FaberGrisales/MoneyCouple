  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: t.bg }]}>
      ...
      <View style={styles.center}>
        <MCText style={{ fontSize: 28 }}>♥</MCText>
        <MCText style={[styles.title, { color: t.text }]}>Dashboard Pareja</MCText>
        <MCText style={[styles.sub, { color: t.textSec }]}>Juan & María — Fase 4</MCText>
      </View>
    </SafeAreaView>
  );
}
